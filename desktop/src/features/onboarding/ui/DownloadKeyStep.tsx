    ...
    >
      ...
      >
        ...
        <h1 className="text-title font-normal text-foreground">
          {hasVerifiedBackup
            ? t("onboarding.download.title_verified")
            : hasSelectedBackup
              ? t("onboarding.download.title_selected")
              : hasCreated
                ? t("onboarding.download.title_created")
                : t("onboarding.download.title_create")}
        </h1>
        <p className="mt-5 text-sm leading-6 text-foreground/80">
          {hasVerifiedBackup
            ? t("onboarding.download.desc_verified")
            : hasSelectedBackup
              ? t("onboarding.download.desc_selected")
              : hasCreated
                ? t("onboarding.download.desc_created")
                : t("onboarding.download.desc_create")}
        </p>
      </motion.div>
