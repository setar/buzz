    ...
    (runAction: () => Promise<boolean | undefined>) => {
      ...
      void Promise.resolve()
        ...
        .catch((error) => {
          ...
          toast.error(t("onboarding.flow.reconnect_error", { detail }));
        })
        .finally(() => {
    ...
    >
      <div className="w-full max-w-2xl">
        ...
        <p className="mt-5 text-sm leading-6 text-muted-foreground">
          {t("onboarding.profile_step.description")}
        </p>
      </div>
          ...
          {!hasDisplayNameDraft ? (
            ...
            >
              <span className="relative inline-flex select-none items-center gap-0 text-4xl font-semibold text-muted-foreground/35 sm:text-5xl">
                ...
                />
                {t("onboarding.profile_step.name_placeholder")}
              </span>
            </div>
          ) : null}
          <input
            aria-label={t("onboarding.profile_step.name_label")}
            autoCapitalize="none"
            autoComplete="off"
            autoCorrect="off"
            className={cn(
      ...
      <OnboardingFooter>
        ...
        >
          {isSaving ? (
            ...
            t("onboarding.profile_step.create_key")
          )}
        </Button>
        ...
        {!usesExistingIdentity ? (
          <Button
            ...
            variant="ghost"
          >
            {t("onboarding.profile_step.have_key")}
          </Button>
        ) : null}
        ...
        <div className="flex min-h-8 items-center gap-2">
          ...
          {saveRecovery.canSkipForNow ? (
            <Button
              ...
              variant="ghost"
            >
              {t("onboarding.profile_step.skip_for_now")}
            </Button>
          ) : null}
          {saveRecovery.canAdvanceWithoutSaving ? (
            <Button
              ...
              variant="ghost"
            >
              {t("onboarding.profile_step.continue_without_saving")}
            </Button>
          ) : null}
          <div className="flex-1" />
        </div>
