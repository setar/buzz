...
function PairingCodeConfirmation({
  ...
  return (
    ...
    >
      ...
      >
        {t("settings.confirm_mobile_code")}
      </p>
      <fieldset
      ...
      >
        <legend className="sr-only">
          {t("settings.confirmation_code")} {formattedCode}
        </legend>
    ...
    <section className="min-w-0" data-testid="settings-mobile">
      ...
      >
        ...
        <p aria-live="polite" className="sr-only" data-testid="pairing-status">
          {step === "sas" && sasCode
            ? t("settings.pairing_sas_status", {
                code: `${sasCode.slice(0, 3)} ${sasCode.slice(3, 6)}`,
              })
            : step === "transferring"
              ? t("settings.pairing_transferring_status")
              : step === "done"
                ? t("settings.pairing_done_status")
                : ""}
        </p>
        <SettingsOptionRow
