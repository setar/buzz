    ...
    <>
      ...
      >
        <AlertDialogContent data-testid="discard-create-agent-dialog">
          <AlertDialogHeader>
            <AlertDialogTitle>{t("agents.discard_agent_changes")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("agents.discard_agent_changes_desc")}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>{t("agents.keep_editing")}</AlertDialogCancel>
            <AlertDialogAction asChild>
              <Button onClick={discardChangesAndNavigate} variant="destructive">
                {t("agents.discard_changes")}
              </Button>
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
