      ...
      >
        ...
        >
          <DialogPrimitive.Title asChild>
            <AuxiliaryPanelTitle>
              {activeView === "canvas" ? t("channel.canvas_title") : t("channel.channel_settings_title")}
            </AuxiliaryPanelTitle>
      ...
      >
        {activeView === "summary" ? (
          <div className="space-y-6 pt-3">
            ...
            <FieldGroup testId="channel-management-details" title={t("channel.details_section")}>
              {resolvedChannel.channelType !== "dm" ? (
                <>
                  <EditableInfoFieldRow
                    editTestId="channel-management-edit-channel-type"
                    label={t("channel.channel_type_label")}
                    onEdit={canEditChannel ? onOpenEdit : undefined}
                    testId="channel-management-type"
                    value={
                      resolvedChannel.ttlSeconds === null
                        ? t("channel.channel_type_ongoing")
                        : t("channel.channel_type_temporary", { duration: formatTtlDuration(resolvedChannel.ttlSeconds) })
                    }
                  />
                  <EditableInfoFieldRow
                    editTestId="channel-management-edit-visibility"
                    label={t("channel.visibility_label")}
                    onEdit={canEditChannel ? onOpenEdit : undefined}
                    testId="channel-management-visibility"
                    value={
                      resolvedChannel.visibility === "private"
                        ? t("channel.visibility_private")
                        : t("channel.visibility_public")
                    }
                  />
                </>
              ) : null}
              <InfoFieldRow
                label={t("channel.members_label")}
                ...
                value={memberCount === 1 ? t("channel.members_count_label", { count: memberCount }) : t("channel.members_count_label_other", { count: memberCount })}
              />
              <CopyFieldRow
                label={t("channel.channel_id_label")}
            ...
            {canOpenCanvas ? (
              <IngressRow
                ...
                helpText={t("channel.canvas_help_text")}
                icon={BookOpenText}
                label={t("channel.canvas_title")}
            ...
            {canJoin || canLeave || canEditChannel ? (
              <FieldGroup testId="channel-management-actions">
                {canJoin ? (
                  <ActionFieldRow
                    description={t("channel.join_channel_desc")}
                    disabled={joinChannelMutation.isPending}
                    icon={DoorOpen}
                    label={
                      joinChannelMutation.isPending
                        ? t("channel.joining_channel")
                        : t("channel.join_channel")
                    }
                    onClick={() => {
                  ...
                  <ActionFieldRow
                    ...
                    label={
                      leaveChannelMutation.isPending
                        ? t("channel.leaving_channel")
                        : t("channel.leave_channel")
                    }
                    onClick={() => {
                    ...
                    <ActionFieldRow
                      ...
                      label={
                        unarchiveChannelMutation.isPending
                          ? t("channel.restoring_channel_label")
                          : t("channel.unarchive_channel_label")
                      }
                      onClick={() => {
                    ...
                    <ActionFieldRow
                      ...
                      label={
                        archiveChannelMutation.isPending
                          ? t("channel.archiving_channel_label")
                          : t("channel.archive_channel_label")
                      }
                      onClick={() => {
                  ...
                  <ChannelDeleteConfirmationDialog
                    ...
                    trigger={
                      <ActionFieldRow
                        ...
                        icon={Trash2}
                        label={t("channel.delete_channel_label")}
