      ...
      <SidebarMenu className="pb-2">
        <SidebarMenuItem>
          ...
          >
            ...
            <SidebarMenuLabel>{t("sidebar.inbox")}</SidebarMenuLabel>
          </SidebarMenuButton>
          {homeBadgeCount > 0 ? (
            <SidebarMenuBadge
        ...
        <FeatureGate feature="pulse">
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              tooltip={t("sidebar.pulse")}
              type="button"
            >
              <Activity className="h-4 w-4" />
              <SidebarMenuLabel>{t("sidebar.pulse")}</SidebarMenuLabel>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </FeatureGate>
        <FeatureGate feature="projects">
          <SidebarMenuItem>
            ...
            >
              ...
              <SidebarMenuLabel>{t("sidebar.projects")}</SidebarMenuLabel>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </FeatureGate>
        <SidebarMenuItem>
          ...
          >
            ...
            <SidebarMenuLabel>{t("sidebar.agents")}</SidebarMenuLabel>
          </SidebarMenuButton>
        </SidebarMenuItem>
        <FeatureGate feature="workflows">
          <SidebarMenuItem>
            ...
            >
              ...
              <SidebarMenuLabel>{t("sidebar.workflows")}</SidebarMenuLabel>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </FeatureGate>
      </SidebarMenu>
